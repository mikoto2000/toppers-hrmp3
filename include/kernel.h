 ...
 *  の責任を負わない．
 * 
 *  $Id: kernel.h 641 2019-12-08 12:25:16Z ertl-hiro $
 */

/*
 *		TOPPERS/HRMPカーネル 標準ヘッダファイル
 *
 *  TOPPERS/HRMPカーネルがサポートするサービスコールの宣言と，必要なデー
 ...
 */
#define SCHEDNO(prcid, domid)	(((domid) << 16) | ((prcid) & 0xffffU))
...
#define TKERNEL_PRID	UINT_C(0x000b)	/* カーネルの識別番号 */
