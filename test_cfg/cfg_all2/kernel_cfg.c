...
const TINIB _kernel_tinib_table[TNUM_TSKID] = {
	{ (DOM1), (TA_ACT), (intptr_t)(1), (TASK)(task1), INT_PRIORITY(MID_PRIORITY), ROUND_STK_T(DEFAULT_SSTKSZ), _kernel_sstack_TASK1, ROUND_STK_T(4096), _kernel_ustack_TASK1, { TACP(DOM1), TACP(DOM1), TACP_SHARED, TACP(DOM1) }, 1, 0x1U },
	{ (DOM1), (TA_NULL), (intptr_t)(2), (TASK)(task2), INT_PRIORITY(HIGH_PRIORITY), STACK_SIZE, (void *)(stack_TASK2), ROUND_STK_T(4096), _kernel_ustack_TASK2, { TACP_SHARED, TACP(DOM1), TACP(DOM1), TACP_SHARED }, 1, 0x1U }
};
...
const CYCINIB _kernel_cycinib_table[TNUM_CYCID] = {
	{ (TA_STA), (intptr_t)(&nvar1), _kernel_nfyhdr_CYC2, (1000), (1000), { TACP_SHARED, TACP(DOM1), TACP(DOM1), TACP_SHARED }, &(_kernel_dominib_table[INDEX_DOM(DOM1)]), 1, 0x1 },
	{ (TA_NULL), (intptr_t)(&nvar2), _kernel_nfyhdr_CYC3, (1000), (1000), { TACP(DOM1), TACP(DOM1), TACP_SHARED, TACP(DOM1) }, &(_kernel_dominib_table[INDEX_DOM(DOM1)]), 1, 0x1 },
	{ (TA_NULL), (intptr_t)(TASK1), _kernel_nfyhdr_CYC4, (1000), (1000), { TACP(DOM1), TACP(DOM1), TACP_SHARED, TACP(DOM1) }, &(_kernel_dominib_table[INDEX_DOM(DOM1)]), 1, 0x1 },
	{ (TA_NULL), (intptr_t)(TASK1), _kernel_nfyhdr_CYC5, (1000), (1000), { TACP(DOM1), TACP(DOM1), TACP_SHARED, TACP(DOM1) }, &(_kernel_dominib_table[INDEX_DOM(DOM1)]), 1, 0x1 },
	{ (TA_NULL), (intptr_t)(SEM1), _kernel_nfyhdr_CYC6, (1000), (1000), { TACP(DOM1), TACP(DOM1), TACP_SHARED, TACP(DOM1) }, &(_kernel_dominib_table[INDEX_DOM(DOM1)]), 1, 0x1 },
	{ (TA_NULL), (intptr_t)(FLG1), _kernel_nfyhdr_CYC7, (1000), (1000), { TACP(DOM1), TACP(DOM1), TACP_SHARED, TACP(DOM1) }, &(_kernel_dominib_table[INDEX_DOM(DOM1)]), 1, 0x1 },
	{ (TA_NULL), (intptr_t)(DTQ1), _kernel_nfyhdr_CYC8, (1000), (1000), { TACP(DOM1), TACP(DOM1), TACP_SHARED, TACP(DOM1) }, &(_kernel_dominib_table[INDEX_DOM(DOM1)]), 1, 0x1 },
	{ (TA_NULL), (intptr_t)(TASK1), _kernel_nfyhdr_CYC9, (1000), (1000), { TACP(DOM1), TACP(DOM1), TACP_SHARED, TACP(DOM1) }, &(_kernel_dominib_table[INDEX_DOM(DOM1)]), 1, 0x1 },
	{ (TA_NULL), (intptr_t)(TASK1), _kernel_nfyhdr_CYC10, (1000), (1000), { TACP(DOM1), TACP(DOM1), TACP_SHARED, TACP(DOM1) }, &(_kernel_dominib_table[INDEX_DOM(DOM1)]), 1, 0x1 }
};
...
const ALMINIB _kernel_alminib_table[TNUM_ALMID] = {
	{ (TA_NULL), (intptr_t)(&nvar1), _kernel_nfyhdr_ALM2, { TACP_SHARED, TACP(DOM1), TACP(DOM1), TACP_SHARED }, &(_kernel_dominib_table[INDEX_DOM(DOM1)]), 1, 0x1 },
	{ (TA_NULL), (intptr_t)(&nvar2), _kernel_nfyhdr_ALM3, { TACP(DOM1), TACP(DOM1), TACP_SHARED, TACP(DOM1) }, &(_kernel_dominib_table[INDEX_DOM(DOM1)]), 1, 0x1 },
	{ (TA_NULL), (intptr_t)(TASK1), _kernel_nfyhdr_ALM4, { TACP(DOM1), TACP(DOM1), TACP_SHARED, TACP(DOM1) }, &(_kernel_dominib_table[INDEX_DOM(DOM1)]), 1, 0x1 },
	{ (TA_NULL), (intptr_t)(TASK1), _kernel_nfyhdr_ALM5, { TACP(DOM1), TACP(DOM1), TACP_SHARED, TACP(DOM1) }, &(_kernel_dominib_table[INDEX_DOM(DOM1)]), 1, 0x1 },
	{ (TA_NULL), (intptr_t)(SEM1), _kernel_nfyhdr_ALM6, { TACP(DOM1), TACP(DOM1), TACP_SHARED, TACP(DOM1) }, &(_kernel_dominib_table[INDEX_DOM(DOM1)]), 1, 0x1 },
	{ (TA_NULL), (intptr_t)(FLG1), _kernel_nfyhdr_ALM7, { TACP(DOM1), TACP(DOM1), TACP_SHARED, TACP(DOM1) }, &(_kernel_dominib_table[INDEX_DOM(DOM1)]), 1, 0x1 },
	{ (TA_NULL), (intptr_t)(DTQ1), _kernel_nfyhdr_ALM8, { TACP(DOM1), TACP(DOM1), TACP_SHARED, TACP(DOM1) }, &(_kernel_dominib_table[INDEX_DOM(DOM1)]), 1, 0x1 },
	{ (TA_NULL), (intptr_t)(TASK1), _kernel_nfyhdr_ALM9, { TACP(DOM1), TACP(DOM1), TACP_SHARED, TACP(DOM1) }, &(_kernel_dominib_table[INDEX_DOM(DOM1)]), 1, 0x1 },
	{ (TA_NULL), (intptr_t)(TASK1), _kernel_nfyhdr_ALM10, { TACP(DOM1), TACP(DOM1), TACP_SHARED, TACP(DOM1) }, &(_kernel_dominib_table[INDEX_DOM(DOM1)]), 1, 0x1 }
};
