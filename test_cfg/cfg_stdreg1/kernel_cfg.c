...
static STK_T _kernel_sstack_TASK4[COUNT_STK_T(STACK_SIZE)] __attribute__((section(".system_stack_CLS_PRC1"),nocommon));
...
const TINIB _kernel_tinib_table[TNUM_TSKID] = {
	{ (TDOM_KERNEL), (TA_NULL), (intptr_t)(4), (TASK)(task4_1), INT_PRIORITY(MID_PRIORITY), ROUND_STK_T(STACK_SIZE), _kernel_sstack_TASK4, 0, NULL, { TACP_KERNEL, TACP_KERNEL, TACP_KERNEL, TACP_KERNEL }, 1, 0x1U },
	{ (DOM1), (TA_NULL), (intptr_t)(5), (TASK)(task5_1), INT_PRIORITY(MID_PRIORITY), ROUND_STK_T(DEFAULT_SSTKSZ), _kernel_sstack_TASK5, ROUND_STK_T(4096), _kernel_ustack_TASK5, { TACP(DOM1), TACP(DOM1), TACP(DOM1), TACP(DOM1) }, 1, 0x1U }
};

static TCB _kernel_tcb_TASK4 __attribute__((section(".kernel_data_CLS_PRC1"),nocommon));
...
static DTQMB _kernel_dtqmb_DTQ3[10] __attribute__((section(".kernel_data_CLS_PRC1"),nocommon));
static DTQMB _kernel_dtqmb_DTQ4[10] __attribute__((section(".kernel_data_CLS_PRC1"),nocommon));
static DTQMB _kernel_dtqmb_DTQ5[10] __attribute__((section(".kernel_data_CLS_PRC1"),nocommon));
const DTQINIB _kernel_dtqinib_table[TNUM_DTQID] = {
	{ (TA_NULL), (10), _kernel_dtqmb_DTQ3, { TACP_SHARED, TACP_SHARED, TACP_SHARED, TACP_SHARED } },
	{ (TA_NULL), (10), _kernel_dtqmb_DTQ4, { TACP_KERNEL, TACP_KERNEL, TACP_KERNEL, TACP_KERNEL } },
	{ (TA_NULL), (10), _kernel_dtqmb_DTQ5, { TACP(DOM1), TACP(DOM1), TACP(DOM1), TACP(DOM1) } }
};

static DTQCB _kernel_dtqcb_DTQ3 __attribute__((section(".kernel_data_CLS_PRC1"),nocommon));
static DTQCB _kernel_dtqcb_DTQ4 __attribute__((section(".kernel_data_CLS_PRC1"),nocommon));
static DTQCB _kernel_dtqcb_DTQ5 __attribute__((section(".kernel_data_CLS_PRC1"),nocommon));
...
static PDQMB _kernel_pdqmb_PDQ3[10] __attribute__((section(".kernel_data_CLS_PRC1"),nocommon));
static PDQMB _kernel_pdqmb_PDQ4[10] __attribute__((section(".kernel_data_CLS_PRC1"),nocommon));
static PDQMB _kernel_pdqmb_PDQ5[10] __attribute__((section(".kernel_data_CLS_PRC1"),nocommon));
const PDQINIB _kernel_pdqinib_table[TNUM_PDQID] = {
	{ (TA_NULL), (10), (16), _kernel_pdqmb_PDQ3, { TACP_SHARED, TACP_SHARED, TACP_SHARED, TACP_SHARED } },
	{ (TA_NULL), (10), (16), _kernel_pdqmb_PDQ4, { TACP_KERNEL, TACP_KERNEL, TACP_KERNEL, TACP_KERNEL } },
	{ (TA_NULL), (10), (16), _kernel_pdqmb_PDQ5, { TACP(DOM1), TACP(DOM1), TACP(DOM1), TACP(DOM1) } }
};

static PDQCB _kernel_pdqcb_PDQ3 __attribute__((section(".kernel_data_CLS_PRC1"),nocommon));
static PDQCB _kernel_pdqcb_PDQ4 __attribute__((section(".kernel_data_CLS_PRC1"),nocommon));
static PDQCB _kernel_pdqcb_PDQ5 __attribute__((section(".kernel_data_CLS_PRC1"),nocommon));
...
static MB_T _kernel_mbfmb_MBF3[TOPPERS_COUNT_SZ(100, sizeof(MB_T))] __attribute__((section(".kernel_data_CLS_PRC1"),nocommon));
static MB_T _kernel_mbfmb_MBF4[TOPPERS_COUNT_SZ(100, sizeof(MB_T))] __attribute__((section(".kernel_data_CLS_PRC1"),nocommon));
static MB_T _kernel_mbfmb_MBF5[TOPPERS_COUNT_SZ(100, sizeof(MB_T))] __attribute__((section(".kernel_data_CLS_PRC1"),nocommon));
const MBFINIB _kernel_mbfinib_table[TNUM_MBFID] = {
	{ (TA_NULL), (10), TOPPERS_ROUND_SZ(100, sizeof(MB_T)), _kernel_mbfmb_MBF3, { TACP_SHARED, TACP_SHARED, TACP_SHARED, TACP_SHARED } },
	{ (TA_NULL), (10), TOPPERS_ROUND_SZ(100, sizeof(MB_T)), _kernel_mbfmb_MBF4, { TACP_KERNEL, TACP_KERNEL, TACP_KERNEL, TACP_KERNEL } },
	{ (TA_NULL), (10), TOPPERS_ROUND_SZ(100, sizeof(MB_T)), _kernel_mbfmb_MBF5, { TACP(DOM1), TACP(DOM1), TACP(DOM1), TACP(DOM1) } }
};

static MBFCB _kernel_mbfcb_MBF3 __attribute__((section(".kernel_data_CLS_PRC1"),nocommon));
static MBFCB _kernel_mbfcb_MBF4 __attribute__((section(".kernel_data_CLS_PRC1"),nocommon));
static MBFCB _kernel_mbfcb_MBF5 __attribute__((section(".kernel_data_CLS_PRC1"),nocommon));
...
static MPF_T _kernel_mpf_MPF3[(10) * COUNT_MPF_T(100)] __attribute__((section(".mpf_MPF3"),nocommon));
static MPFMB _kernel_mpfmb_MPF3[10] __attribute__((section(".kernel_data_CLS_PRC1"),nocommon));
static MPF_T _kernel_mpf_MPF4[10 * COUNT_MPF_T(100)] __attribute__((section(".kernel_data_CLS_PRC1"),nocommon));
static MPFMB _kernel_mpfmb_MPF4[10] __attribute__((section(".kernel_data_CLS_PRC1"),nocommon));
static MPF_T _kernel_mpf_MPF5[(10) * COUNT_MPF_T(100)] __attribute__((section(".mpf_MPF5"),nocommon));
...
const MPFINIB _kernel_mpfinib_table[TNUM_MPFID] = {
	{ (TA_NULL), (10), ROUND_MPF_T(100), _kernel_mpf_MPF3, _kernel_mpfmb_MPF3, { TACP_SHARED, TACP_SHARED, TACP_SHARED, TACP_SHARED } },
	{ (TA_NULL), (10), ROUND_MPF_T(100), _kernel_mpf_MPF4, _kernel_mpfmb_MPF4, { TACP_KERNEL, TACP_KERNEL, TACP_KERNEL, TACP_KERNEL } },
	{ (TA_NULL), (10), ROUND_MPF_T(100), _kernel_mpf_MPF5, _kernel_mpfmb_MPF5, { TACP(DOM1), TACP(DOM1), TACP(DOM1), TACP(DOM1) } }
};
...
static STK_T _kernel_istack_prc1[COUNT_STK_T(10 * STACK_SIZE)] __attribute__((section(".system_stack_CLS_PRC1"),nocommon));
...
STK_T *const _kernel_istkpt_table[TNUM_PRCID] = {
	TOPPERS_ISTKPT(_kernel_istack_prc1, ROUND_STK_T(10 * STACK_SIZE)),
...
TMEVTN	_kernel_tmevt_heap_kernel_prc1[1 + 2] __attribute__((section(".kernel_data_CLS_PRC1"),nocommon));
