 ...
 *  の責任を負わない．
 * 
 *  $Id: task_refer.c 447 2019-10-05 01:29:22Z ertl-hiro $
 */
...
ref_tsk(ID tskid, T_RTSK *pk_rtsk)
{
	...
	CHECK_TSKCTX_UNL_MYSTATE(&p_selftsk, &selfdom);	/*［NGKI1218］［NGKI1219］*/
	if (tskid == TSK_SELF) {
	...
	CHECK_MACV_WRITE(pk_rtsk, T_RTSK, p_selftsk, selfdom);	/*［NGKI1223］*/
	CHECK_ACPTN(p_tcb->p_tinib->acvct.acptn4, selfdom);	/*［NGKI1222］*/
