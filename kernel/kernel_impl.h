 ...
 *  の責任を負わない．
 * 
 *  $Id: kernel_impl.h 675 2019-12-18 19:33:07Z ertl-hiro $
 */

/*
 *		TOPPERS/HRMPカーネル内部向け標準ヘッダファイル
 *
...
/*
 *  スケジューリング単位番号からプロセッサIDの取得
 */
#define SCHEDNO_PRCID(schedno)		(schedno & 0xffffU)

/*
 *  スケジューリング単位番号からドメインIDの取得
 */
#define SCHEDNO_DOMID(schedno)		(schedno >> 16U)
