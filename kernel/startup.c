 ...
 *  の責任を負わない．
 * 
 *  $Id: startup.c 698 2019-12-29 01:42:57Z ertl-hiro $
 */
...
sta_ker(void)
{
	 ...
	 *  する必要がある．
	 */
	initialize_memory(p_my_pcb);
	initialize_tmevt(p_my_pcb);						/*［ASPD1061］*/
	initialize_domain(p_my_pcb);
	...
	if (p_my_pcb->p_tmevt_heap_kernel != NULL) {
